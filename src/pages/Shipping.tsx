...
const shippingPolicies = [
  {
    ...
    content: 'Orders must be placed by 2:00 PM for same-day delivery. Orders placed after 2:00 PM will be delivered the next business day.'
  },
  {
    icon: Package,
    title: 'Packaging',
    content: 'All items are carefully packaged to maintain freshness and prevent damage during transport. We use eco-friendly packaging materials whenever possible.'
  },
  {
    icon: Shield,
    title: 'Delivery Guarantee',
    content: 'We guarantee your order will arrive fresh and in perfect condition. If you\'re not satisfied, we\'ll replace your order or provide a full refund.'
  },
  {
    icon: MapPin,
    title: 'Delivery Areas',
    content: 'We deliver throughout the metro area and ship state-wide. Check our delivery map or contact us to confirm delivery to your location.'
  }
];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="bg-primary-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Fresh baked goods delivered to your door with care and attention to quality.
          </motion.p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Custom cakes require special handling and are only available for local delivery. 
                    We personally deliver all custom cakes to ensure they arrive in perfect condition.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Delicate pastries and decorated items receive extra protective packaging. 
                    We may recommend pickup for extremely fragile items.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Orders over $150 qualify for free local delivery. We offer special rates 
                    for catering and event orders.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  Orders over $150 qualify for free local delivery within our standard delivery area.
                </p>
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Our team is happy to help you choose the best shipping option for your needs.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
