		...
		<section id="story" className="relative py-20 bg-primary-50 dark:bg-gray-800">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						>
							...
							ingredients to serving our community.
						</motion.p>
					</div>
			...
			<section className="py-16 bg-primary-600 text-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					>
						Visit us today and experience the passion, quality, and tradition that
						has made us a beloved part of the community for nearly four decades.
					</motion.p>
					<motion.div
						initial={{ opacity: 0, y: 20 }}
						whileInView={{ opacity: 1, y: 0 }}
